          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" data-toggle="validator">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="file" class="form-control" id="Title" data-error="未選擇任何檔案" required>
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="Title" data-error="請輸入產品名稱" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
                <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="Title" data-error="請輸入價格" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
                <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="Title" data-error="請輸入保存期限" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">商品說明</label>
                </div>
                <div class="col-sm-10">
